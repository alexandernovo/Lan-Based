...
{
    function send($message, $clientSocketArray)
    {
    ...
    function createAnnouncementMessage($announcement_data)
    {
        $messageArray = array('name' => 'announcement', 'data' => $announcement_data);
