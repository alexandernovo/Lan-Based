                            ...
                            <div class="w-50">
                                <div class="form-row">
                                    ...
                                    <select class="form-control" name="question_type">
                                        <option <?= $activity['question_type'] == "Short Answer" ? "selected" : "" ?> value="Short Answer">Short Answer</option>
                                        <option <?= $activity['question_type'] == "Multiple Choice" ? "selected" : "" ?> value="Multiple Choice">Multiple Choice</option>
                                    </select>
                                </div>
                                <div class="form-row">
                                    <label class="mx-0">Question Title</label>
                                    <input required value="<?= $activity['activity_title'] ?>" class="form-control" name="activity_title" placeholder="Question Title" />
                                ...
                                <div class="form-row">
                                    ...
                                    <textarea required name="activity_description" class="form-control  description-activity" placeholder="Question Description"><?= $activity['activity_description'] ?></textarea>
                                ...
                                <div class="form-check mt-2">
                                    <input required checked="<?= $activity['isDueDate'] ?>" name="isDueDate" class="form-check-input" type="checkbox" value="1" id="flexCheckDefault">
                                ...
                                <button type="submit" name="edit_question" class="btn btn-success mt-3 px-4 btn-sm">
