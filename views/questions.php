        ...
        <div class="col-12">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row mt-3">
                        <?php
                        $activities = find_where('activity', ['class_id' => $_GET['class_id'], 'activity_type' => 'question']);
                        ?>
                                ...
                                <div class="card">
                                    <div class="card-body p-3">
                                        <div class="activities-images">
                                            <img src="public/assets/img/questions.png" class="preview-image-options border">
                                        </div>
                                        <p class="m-0 mt-1 class-title"><?= $activity['activity_title'] ?></p>
                                        <p class="m-0 mt-1 activity-due"><?= $activity['question_type'] ?></p>
