...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 08, 2024 at 02:12 PM
...
INSERT INTO `notifications` (`included_id`, `notification_datetime`, `notification_description`, `notification_id`, `notification_title`, `notification_type`, `user_id`) VALUES
(6, '2024-09-04 00:00:00', 'IT-138 (3-A) Quasi esse pariatur Activity Created', 1, 'Created Activity', 'activity', 1),
(6, '2024-09-04 00:00:00', 'Lynn has joined your class', 2, 'Joined Class', 'class', 1),
(6, '2024-09-04 00:00:00', 'Lynn Salas has joined your class', 3, 'Joined Class', 'class', 1),
(6, '2024-09-04 00:00:00', 'Lynn Salas has joined your class', 4, 'Joined Class', 'class', 1),
(6, '2024-09-04 00:00:00', 'Lynn Salas has joined your class', 5, 'Joined Class', 'class', 1),
(6, '2024-09-04 00:00:00', 'Lynn Salas has joined your class', 6, 'Joined Class', 'class', 1),
(6, '2024-09-04 00:00:00', 'Lynn Salas has joined your class', 7, 'Joined Class', 'class', 1),
(6, '2024-09-04 00:00:00', 'Lynn Salas has joined your class', 8, 'Joined Class', 'class', 1);
...
--
ALTER TABLE `activity`
  MODIFY `activity_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
ALTER TABLE `attachments`
  MODIFY `attachment_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
...
--
ALTER TABLE `class_people`
  MODIFY `class_people_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=92;
